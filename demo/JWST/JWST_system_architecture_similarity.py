...
def main():
    ...
    gen_fp = r'data\JWST_outputs\JWST_system_architectures\JWST_system_architecture_0.txt'
    # Create preprocessor object and turn txt file to dict
    preprocessor = RawData2Python()
    ...
    sentence.run()
    sentence.plot("JWST System Architecture Similarity using Cosine Similarity", 'Validation Components', 'Generated Components', valid_ticks, gen_ticks, 5)
