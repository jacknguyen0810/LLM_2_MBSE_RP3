...
def main():
    ...
    valid_fp = r'data\validation_data\PROVE_modes.txt'
    ...
    gen_fp = r'data\PROVE_outputs\PROVE_modes\PROVE_phases_0.txt'
    # Create preprocessor object and turn txt file to dict
    preprocessor = RawData2Python()
    ...
    sentence.run()
    sentence.plot("PROVE Mode Similarity using Cosine Similarity", 'Validation Modes', 'Generated Modes', None, None, 8)
