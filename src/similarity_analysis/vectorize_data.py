...
class SentenceSimilarityAnalysis:
    ...
    def __init__(self, text_tokens1: dict, text_tokens2: dict, metric: str = None, vector_type: str = None) -> None:
    ...
    def run(self) -> None:
        ...
        comp_metric = self.similarity_metric_functions.get(self.metric, self.metric_error)
